...
- **Wave 3 — in progress**: `foundation/shortcuts` (keybindings) **DONE** · `foundation/format` (humanizers) **DONE** (both 2026-07-13); command-registry/palette layer (W3-c) queued · `foundation/files` · `analytics` event bus · `flags` (OpenFeature-shaped) all queued.
