...
- **Wave 3 — in progress**: `foundation/shortcuts` (keybindings) **DONE** (2026-07-13); command-registry/palette layer (W3-c) queued · `foundation/files` + `foundation/format` · `analytics` event bus · `flags` (OpenFeature-shaped) all queued.
