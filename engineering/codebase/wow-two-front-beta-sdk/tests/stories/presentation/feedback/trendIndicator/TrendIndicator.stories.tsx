...
import { TrendIndicator } from '@src/presentation/feedback/trendIndicator/TrendIndicator';
...
export const Inverse: Story = { args: { value: 5.2, isInverse: true, label: 'churn' } };
