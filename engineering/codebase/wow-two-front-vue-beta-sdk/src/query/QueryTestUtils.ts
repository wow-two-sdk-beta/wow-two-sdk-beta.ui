...
export type MountWithQueryResult = VueWrapper & { readonly client: QueryClient };
...
/** @deprecated The React name for {@link mountWithQuery} — kept so a ported test compiles; the signature is the Vue one (component + mounting options). */
...
export interface RunWithQueryResult<T> {
