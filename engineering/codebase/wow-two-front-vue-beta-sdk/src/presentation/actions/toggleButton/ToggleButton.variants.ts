...
const _assertToggleButtonVariant: AssertExact<ToggleButtonVariant, NonNullable<ToggleButtonVariants['variant']>> = true;
const _assertToggleButtonTone: AssertExact<ColorTone, NonNullable<ToggleButtonVariants['tone']>> = true;
