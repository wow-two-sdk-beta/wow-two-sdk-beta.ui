<script lang="ts">
/**
 * The prop surface of `CommandPaletteInput`.
 *
 ...
 */
export type CommandPaletteInputProps = Record<string, never>;
...
import { useCommandPaletteContext, type CommandItemEntry } from './CommandPaletteContext';

/** The palette's search field — a `role="combobox"` driving the option list. */
