...
Source: [MenubarMenu.vue](MenubarMenu.vue).

Public import: `import { MenubarMenu } from '@wow-two-beta/ui-vue/presentation/nav';`.

## Contract

- Mount within the owner supplying `useMenubarContext`; a compound part is not an independent root.
...
|---|---|---|---|---|
| `value` | `string` | yes | — | The stable id for this menu — used for active-menu tracking. |
