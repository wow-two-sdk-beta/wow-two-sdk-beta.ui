...
Source: [HStackLayout.vue](HStackLayout.vue).

Public import: `import { HStackLayout } from '@wow-two-beta/ui-vue/presentation/layout';`.
...
|---|---|---|
| `default` | `default?(): unknown;` | The children laid out left to right. |
