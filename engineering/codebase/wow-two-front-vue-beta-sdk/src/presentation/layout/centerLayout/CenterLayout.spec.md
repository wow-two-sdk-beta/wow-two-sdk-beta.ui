...
Source: [CenterLayout.vue](CenterLayout.vue).

Public import: `import { CenterLayout } from '@wow-two-beta/ui-vue/presentation/layout';`.
...
|---|---|---|
| `default` | `default?(): unknown;` | The content centered on both axes. |
