 ...
 * numbered chip — for margin markers or floating layers (position via `class`).
 */
defineOptions({ name: 'AnnotationMarker', inheritAttrs: false });
...
const props = withDefaults(defineProps<AnnotationMarkerProps>(), { tone: 'comment' });
...
const classes = computed(() =>
  isPin.value
    ...
    : cn(
        ...
        'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
        TONE_HIGHLIGHT[effectiveTone.value],
