...
/**
 * Confetti burst. Imperative `fire()` via the exposed handle, or `canAutoFire`
 * on mount. SVG particles animated by rAF. No-op under `prefers-reduced-motion`.
 */
...
function fire(opts?: ConfettiFireOptions): void {
...
defineExpose<ConfettiHandle>({ fire });
</script>
