...
export { default as CollapsibleTrigger, type CollapsibleTriggerProps } from './CollapsibleTrigger.vue';
export { default as CollapsibleContent, type CollapsibleContentProps } from './CollapsibleContent.vue';
export { CollapsibleKey, useCollapsibleContext, type CollapsibleContextValue } from './CollapsibleContext';
