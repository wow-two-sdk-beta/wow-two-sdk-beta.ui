...
interface AgendaGroup {
  ...
  events: Array<EventCalendarEvent>;
}
</script>
...
/* The chronological agenda list of an `EventCalendar`. Internal — never exported. */
...
const groups = computed<Array<AgendaGroup>>(() => {
  ...
  const map = new Map<string, Array<EventCalendarEvent>>();
...
function dotStyle(e: EventCalendarEvent): StyleValue {
