...
Source: [RadioField.vue](RadioField.vue).

Public import: `import { RadioField } from '@wow-two-beta/ui-vue/presentation/forms';`.
...
Inherited contracts: `extends RadioInputProps`. These members remain part of the component surface.
...
| `wrapperClassName` | `string` | no | — | The wrap-element class (the `<label>`). Vue's `class` fallthrough attr reaches the RADIO, not the root. Style the wrapper through this prop. |
