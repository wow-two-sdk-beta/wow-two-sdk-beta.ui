...
export interface StepperStepProps {
  /** The value this step selects — pairs it with the `StepperPanel` of the same value. */
  value: string;
...
import { StepStatus, useStepperContext } from './StepperContext';

/** A single step button plus its trailing connector. */
...
const props = withDefaults(defineProps<StepperStepProps>(), { isDisabled: false });
