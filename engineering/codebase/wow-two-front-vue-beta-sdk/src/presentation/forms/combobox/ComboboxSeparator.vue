...
import { listboxSeparatorVariants } from '../listbox/Listbox.variants';

/**
 * Provides a thin horizontal rule between groups of options. Decorative only —
 * `separator` is not an allowed child role of `listbox` (grid/option/group only),
...
defineOptions({ name: 'ComboboxSeparator' });
</script>
