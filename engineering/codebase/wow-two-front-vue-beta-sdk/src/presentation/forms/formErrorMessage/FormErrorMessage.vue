 ...
 *
 * Without an override it renders the context's `errors` (fed by the forms-engine
 * `Field` glue) — ALL of them, client + server merged. Pass `message`, or fill
 * the default slot, to override with a single hand-written message.
 */
