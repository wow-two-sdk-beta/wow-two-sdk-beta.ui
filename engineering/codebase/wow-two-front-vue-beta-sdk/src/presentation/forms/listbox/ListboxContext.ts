...
export interface ListboxContextValue {
  ...
  readonly indicator: ListboxIndicator;
...
export const listboxContextKey: InjectionKey<ListboxContextValue> = Symbol('wow-two.listbox');

/** Reads the surrounding listbox context; throws when used outside a `<Listbox>`. */
