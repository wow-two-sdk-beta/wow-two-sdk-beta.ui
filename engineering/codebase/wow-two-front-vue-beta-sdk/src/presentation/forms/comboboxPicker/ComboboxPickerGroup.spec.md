...
Source: [ComboboxPickerGroup.vue](ComboboxPickerGroup.vue).

Public import: `import { ComboboxPickerGroup } from '@wow-two-beta/ui-vue/presentation/forms';`.
...
|---|---|---|
| `default` | `default(): unknown;` | The options this group heads. |
