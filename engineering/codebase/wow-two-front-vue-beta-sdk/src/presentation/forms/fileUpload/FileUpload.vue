 ...
 * `files-change`. The zone itself is a `role="button"` — Enter/Space opens
...
const emit = defineEmits<{
  /** Emits the partitioned pick. Replaces React's `onFilesChange`. */
...
function partition(files: FileList | ReadonlyArray<File>): [File[], ReadonlyArray<FileRejection>] {
