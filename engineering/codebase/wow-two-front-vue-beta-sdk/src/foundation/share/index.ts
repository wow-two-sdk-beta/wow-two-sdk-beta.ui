...
// `useShare` (a thin Vue state machine over the two). No HTTP, no components — a share button is a consumer
// of these rules, not their owner; Vue appears only in `UseShare`.
//
...
// the framework-free path cannot delegate to that composable.
