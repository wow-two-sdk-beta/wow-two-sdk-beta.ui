...
// `getGeolocationPermission` (the grant), `distanceBetween` (haversine, platform-free), and the two Vue
// bindings `useGeolocation` / `useWatchPosition`. No HTTP, no components — a "Use my location" button or a map
// pin is a consumer of these rules, not their owner; Vue appears only in the two `Use*` modules.
//
