...
//
// Kept OUT of the composable files, and free of Vue, for two reasons: both composables need exactly the same
// fold (a one-shot request and a watch emission update state identically), and the interesting decisions below
// are then testable without a renderer.
//
...
/**
 * Folds one {@link PositionResult} into the current reading. Pure; exported for the two composables and for tests,
