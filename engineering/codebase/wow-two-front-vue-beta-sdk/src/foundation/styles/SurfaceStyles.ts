...
import { Tone } from './enums/StyleTokens';
...
export const surfaceVariants = tv({
  base: 'outline-hidden transition-colors',
  variants: {
    variant: {
...
/** Represents the semantic colour axis — the shared `Tone` (neutral · primary · danger · success · warning · info). */
