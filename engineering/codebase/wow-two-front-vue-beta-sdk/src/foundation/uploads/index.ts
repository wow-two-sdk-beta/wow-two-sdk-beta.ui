...
// bounded concurrency, retry, cancellation, and progress aggregation, plus the Vue seam that binds it. The
...
// Vue — queue subscription primitives (explicit queue) + the component-scoped convenience
export {
  useUploadQueue,
