...
// Vue bindings `useNotificationPermission` / `usePermissionState`. No HTTP, no components — an "Enable
// notifications" button is a consumer of these rules, not their owner; Vue appears only in the two `Use*`
// modules.
//
